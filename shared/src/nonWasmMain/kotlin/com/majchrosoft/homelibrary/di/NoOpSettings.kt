...
object NoOpSettings : Settings {
    ...
    override fun getInt(
        key: String,
        defaultValue: Int,
    ): Int = store[key]?.toIntOrNull() ?: defaultValue
    ...
    override fun getLong(
        key: String,
        defaultValue: Long,
    ): Long = store[key]?.toLongOrNull() ?: defaultValue
    ...
    override fun getDouble(
        key: String,
        defaultValue: Double,
    ): Double = store[key]?.toDoubleOrNull() ?: defaultValue
    ...
    override fun getFloat(
        key: String,
        defaultValue: Float,
    ): Float = store[key]?.toFloatOrNull() ?: defaultValue
    ...
    ): Boolean = store[key]?.toBooleanStrictOrNull() ?: defaultValue
