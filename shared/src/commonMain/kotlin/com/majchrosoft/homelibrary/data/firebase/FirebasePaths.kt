...
internal object FirebasePaths {
    ...
    fun userBookcase(userId: String, bookcaseId: String) = "users/$userId/bookcases/$bookcaseId"

    fun userItems(userId: String) = "users/$userId/items"
    fun userItem(userId: String, itemId: String) = "users/$userId/items/$itemId"

    /** Public catalog projection — only items where shareable=true are mirrored here by a Cloud Function. */
    const val sharedCatalog = "catalog/items"
}
